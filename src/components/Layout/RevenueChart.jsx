...
function RevenueChart() {
    return (
        <div className='bg-white/80 dark:bg-slate-900/80 backdrop-b-xl rounded-blur-2xl border-slate-200/50 dark:border-slate-700/50 p-6 '>
            <div className='flex items-center justify-between mb-6'>
                <div>
                    <h3 className='text-xl font-bold text-slate-800 dark:text-white'>
                        Revenue Chart
                    </h3>
                    <p className='text-sm text-slate-500 dark:text-slate-400'>Monthly revnue</p>
                </div>
            ...
            <div className='h-80'>
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <Tooltip />
                        {/* <Legend /> */}
                        <Bar dataKey="revenue" fill="url(#colorPv)"  />
                        <Bar dataKey="expenses" fill="url(#colorUv)"  />
                    </BarChart>
                </ResponsiveContainer>
